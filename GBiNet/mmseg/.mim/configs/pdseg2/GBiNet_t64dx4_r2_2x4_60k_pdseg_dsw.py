...
num_classes=5
ghost_ratio=2                       # 2
detail_channels=(16, 32, 64)        # (64, 64, 128)
semantic_channels=(8, 16, 32, 64)  # (16, 32, 64, 128)
decode_channels = semantic_channels[-1]*4               # 1024
...
work_dir = 'E:\project_data\p6_pdySeg2022/work_dirs3/GBiNet_t64dx4_r2_2x4_60k_pdseg_dsw/'
