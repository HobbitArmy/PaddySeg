...
num_classes=5
ghost_ratio=8                       # 2
detail_channels=(64, 64, 128)        # (64, 64, 128)
semantic_channels=(16, 32, 64, 128)  # (16, 32, 64, 128)
decode_channels = 1024               # 1024
model = dict(
    backbone=dict(
...
work_dir = 'E:\project_data\p6_pdySeg2022\/work_dirs3/GBiNet_r8_2x4_60k_pdseg/'
