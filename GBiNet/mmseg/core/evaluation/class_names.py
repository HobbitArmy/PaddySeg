...
def pdseg_classes():
    """Pascal HTHT class names for external use."""
    # return ['water', 'traffic', 'building',
            # 'farmland', 'grassland', 'woodland', 'ground', 'others']
    return ['others', 'seedling', 'jointing', 'heading', 'filling']


def pdseg_palette():
    """Pascal HTHT palette for external use."""
    # return [[128, 0, 0], [0, 128, 0], [128, 128, 0], [0, 0, 128],
            # [128, 0, 128], [0, 128, 128], [128, 128, 128], [64, 0, 0]]
    return [[0, 0, 0], [255, 255, 127], [0, 85, 255], [255, 105, 253], [255, 0, 0]]
